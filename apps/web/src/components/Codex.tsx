    ...
    <section className="codex">
      ...
      {sec === 'items' && (
        <div className="tablewrap">
          ...
          <p className="hint">등급 1 은 처음부터, 2 는 가도, 3 은 폐허 요새가 열리면 상점에 나온다. 무기 종류: 전사 검 · 도적 단검 · 마법사 지팡이 · 프리스트 성물 · 엘프 활 · 모험가 전용(상점·제작 없음, 전직하면 진화). 강화는 +5 까지, 단계마다 공격·방어 고정치 +10%. **무기 스킬**이 적힌 무기는 그것을 든 동안 그 스킬을 수칙에 넣을 수 있다 — 배우는 것이 아니라 드는 것이다.</p>
