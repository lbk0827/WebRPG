...
const SECTIONS: SectionDef[] = [
  ...
  { key: 'stats', label: '스탯', help: '분배는 미리보기다. 확정을 눌러야 저장된다. 주 스탯 몰빵이 최적은 아니다 — 속도를 20~40% 섞는 쪽이 언제나 낫다. 지능은 패턴 칸을 산다. 운은 25 를 넘긴 만큼 더블 크리티컬을 산다 — 20% 쯤 섞으면 후반에 이득, 40% 는 과하다 (docs/18 §18).' },
